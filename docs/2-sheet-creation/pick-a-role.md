...
Ainda queremos que os personagens possam ter uma evolução única, mas acreditamos que isso pode ser feito através da introdução de um sistema inteligente de Papeis de Jogo.

O RPG do Fábulas possui diversas mecânicas que se aplicam ao combate, e quando se trata de combate, cada personagem tem o seu Papel.

Alguns focam em ajudar a equipe, outros focam em receber o dano, ou quem sabe até..negociar com os inimigos!
Em RPGs tradicionais, por exemplo, Barbaros são tipicamente Carregadores, enquanto Rangers são tipicamente Atiradores.

A diferença pode não parecer relevante, mas o que muda no Fábulas, é que *não queremos que uma classe defina a personalidade do seu personagem*, ao invés disso, tudo que precisamos que você nos diga é **o tipo de combate que o seu personagem se especializará ao longo do jogo.**
...
Os Grimos são pedras que possuem poder mágico armazenado, e todo RPG do Fábulas se norteia em volta deles.
...
Sempre que o seu personagem passar de nível, no momento que atinger um nível de Tier (5, 10, 15, 20), ele poderá, se quiser trocar o seu Papel de Jogo.
Caso tenha se arrependido da mudança, seu personagem deverá aguardar até a progressão do próximo tier para trocar novamente.
