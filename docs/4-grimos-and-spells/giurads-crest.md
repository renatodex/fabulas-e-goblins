...
import hammerboy from './../../data/spells/spells-giurad/tier1/hammerboy.json'
import knights_magic from './../../data/spells/spells-giurad/tier1/knights_magic.json'
import lancerboy from './../../data/spells/spells-giurad/tier1/lancerboy.json'
import squire_specialization from './../../data/spells/spells-giurad/tier1/squire_specialization.json'
import swordman from './../../data/spells/spells-giurad/tier1/swordman.json'
