...
|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------|---------------|------------|-------------------------------------------------------------------------------------|--------------|------------|--------------|
| <img src="https://s3.us-west-2.amazonaws.com/fabulas-e-goblins-book/%5Cvscode%5C28df9fc9-21e5-4a87-a8fb-afa90f6640e7.PNG" width="80" /> | Cajado de Pó de Gema | Físico/Mágico | `2d8 + 2`  | Cajado inicial do Aventureiro, ataca a longa distância* com um feixe não elemental. | 2 Cargas     | Elo Mágico | Mágico       |
