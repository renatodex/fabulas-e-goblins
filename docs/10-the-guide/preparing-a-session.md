...
A sessão consiste em um determinado pedaço da do jogo (ou a história toda, no caso de uma [One-Shot](/docs/10-the-guide/fundamentals)) que possa ser jogado em poucas horas.
...
Prepare alguns inimigos para combater os jogadores. Se precisar de ajuda para preparar combates, temos uma [seção específica](/docs/10-the-guide/preparing-combats) para isso aqui no livro.
